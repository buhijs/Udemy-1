...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //Start the consumer
            Runnable consumerWorker = new WritePipelineRunnable(writer, writeQ);
            consumeExecutor.execute(consumerWorker);

            //Start the error consumer
            Runnable errorConsumerWorker = new WritePipelineRunnable(errorWriter, errorWriteQ);
            ...
            ((WritePipelineRunnable)consumerWorker).stop();
            ((WritePipelineRunnable)errorConsumerWorker).stop();
...
//Create rules misc need the history of the rules that were processed and how many times
